...
class MovingObject(QGraphicsEllipseItem):
    ...
    def mouseMoveEvent(self, event):
        orig_cursor_osition = event.lastScenePos()
        updated_cursor_position = event.scenePos()

        orig_position = self.scenePos()

        updated_cursor_x = updated_cursor_position.x() - orig_cursor_osition.x() + orig_position.x()
        updated_cursor_y = updated_cursor_position.y() - orig_cursor_osition.y() + orig_position.y()
